...
export default function CustomerPortalPage() {
  ...
  const changePassword = async () => {
    ...
    setChanging(false);
    if (changeError) setError(changeError.message); else { await supabase.auth.updateUser({ data: { must_change_password: false } }); setMustChangePassword(false); setNewPassword(""); setMessage("Your password was updated successfully."); }
  };
