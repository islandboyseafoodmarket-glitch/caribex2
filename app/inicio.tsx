    ...
    <section className="inicio-section page-section">
      <div className="inicio-container">
        ...
        <header className="inicio-section-header">
          ...
          <p>
            {isEn
              ? "Total trust across the entire Caribbean region"
              : "Confianza total en toda la región del Caribe"}
          </p>
        </header>

        <div className="inicio-testimonials-grid">
          <div className="inicio-testimonial-card">
            <p className="inicio-testimonial-text">
              {isEn
                ? "\" Excellent service and competitive pricing. Caribex is our trusted partner for cargo transport. \""
                : "\" Excelente servicio y precios competitivos. Caribex es nuestro socio de confianza para transporte de carga. \""}
            </p>
          ...
          <div className="inicio-testimonial-card">
            <p className="inicio-testimonial-text">
              {isEn
                ? "\" The LCL service is perfect for our smaller shipments. Highly professional team. \""
                : "\" El servicio LCL es perfecto para nuestros envíos más pequeños. Equipo altamente profesional. \""}
            </p>
          ...
          <div className="inicio-testimonial-card">
            <p className="inicio-testimonial-text">
              {isEn
                ? "\" Exceptional support. They truly care about their clients and the safety of their cargo. \""
                : "\" Soporte excepcional. Realmente se preocupan por sus clientes y la seguridad de su carga. \""}
            </p>
